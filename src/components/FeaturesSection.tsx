...
const FeaturesSection = () => {
  ...
  return <section className="pt-8 pb-20 bg-white py-[80px]">
      <div className="max-w-7xl mx-auto px-[48px]">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">We empower HR professionals move beyond daily firefighting and focus on strategic engagement that truly matters.</p>
        </div>
          ...
          {features.map(feature => <TabsContent key={feature.id} value={feature.id} className="mt-0">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  {/* New Sign Up Now CTA */}
                  <div className="pt-4">
                    <button className="text-pink-500 font-semibold text-lg hover:text-pink-600 transition-colors cursor-pointer">
                      Sign Up Now →
                    </button>
                  </div>
                </div>
