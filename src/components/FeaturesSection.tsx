...
const FeaturesSection = () => {
  ...
  return <section className="pt-32 pb-20 bg-white py-[90px]">
      <div className="max-w-7xl mx-auto px-[48px]">
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
          ...
          {features.map(feature => <TabsContent key={feature.id} value={feature.id} className="mt-0">
              <div className={`grid lg:grid-cols-2 gap-12 items-center transition-all duration-700 ease-out ${isContentVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-16'}`}>
