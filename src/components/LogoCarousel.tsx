  ...
  const logos = [
    {
      id: 1,
      name: "Chai Days",
      src: "/lovable-uploads/baa91ac4-bacf-43fb-81e7-7fd1796bd338.png"
    },
    {
      id: 2,
      name: "DPD Zero",
    ...
    },
    {
      ...
      src: "/lovable-uploads/6ad32495-912d-4b47-bc5b-6904cc4ff79b.png"
    },
    {
      id: 4,
    ...
    },
    {
      id: 5,
      name: "Sona Comstar",
      src: "/lovable-uploads/71021659-977e-472c-9b8e-227ca8a6bff4.png"
    },
    {
      id: 6,
      name: "SIS",
      src: "/lovable-uploads/56fc52e0-a841-4b17-a8ac-e498fe418fbd.png"
    },
    {
      id: 7,
      name: "Paytm",
    ...
    },
    {
      ...
      src: "/lovable-uploads/fddfa5f5-7050-43bc-82eb-6b8f442b8692.png"
    },
    {
      id: 9,
      name: "Whistle Drive",
      src: "/lovable-uploads/cbc9857f-0271-482c-9bd5-a1612afa5efe.png"
    },
    {
      id: 10,
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div 
          ...
          className={`text-center mb-8 transition-all duration-700 ${
            titleVisible ? 'animate-fade-in' : 'opacity-0 translate-y-4'
          }`}
        >
        ...
        <div 
          ...
          className={`transition-all duration-700 delay-300 ${
            carouselVisible ? 'animate-slide-up' : 'opacity-0 translate-y-8'
          }`}
        >
          <div 
            ref={scrollerRef} 
          ...
          >
            <div className="scroller-inner flex gap-16 animate-scroll hover:[animation-play-state:paused]">
              {logos.map(logo => (
                <div 
                  key={logo.id} 
                  className="flex items-center justify-center min-w-[280px] h-20 p-6 flex-shrink-0 px-0 py-0"
                >
                  <img 
                    src={logo.src} 
                    alt={logo.name} 
                    className="max-w-full max-h-full filter grayscale hover:grayscale-0 transition-all duration-300 opacity-100 hover:opacity-100 object-contain transform hover:scale-110" 
                  />
                </div>
              ))}
            </div>
