...
const DesktopNavigation = () => {
  return <>
      ...
      <div className="hidden lg:flex items-center space-x-4">
        ...
        <Button variant="outline" className="border-gray-300 bg-white/10 text-gray-200 hover:text-white hover:bg-white/20 hover:border-white/40 px-6 py-2 rounded-lg font-medium text-sm">Employer Sign In</Button>
      </div>
    </>;
};
