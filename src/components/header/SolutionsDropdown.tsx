  ...
  return (
    <DropdownMenu onOpenChange={setIsDropdownOpen}>
      <DropdownMenuTrigger asChild>
        <button
          className={`text-sm font-medium transition-colors flex items-center px-4 py-2 rounded-lg ${
            isDropdownOpen ||
            isHiringSolutionsPage ||
            isVerificationPage ||
            isIndustriesPage
      ...
      >
        <div
          className="bg-white backdrop-blur-[12px] border border-gray-200/40 rounded-2xl shadow-2xl min-w-[800px] overflow-hidden"
          style={{
            boxShadow:
              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="space-y-3">
                    <button
                      onClick={() =>
                        handleHiringSolutionClick("job-marketplace")
                      }
                    ...
                    <button
                      onClick={() =>
                        handleHiringSolutionClick("guaranteed-hiring")
                      }
                      className="flex items-center p-3 rounded-lg border transition-all group w-full text-left hover:bg-pink-50 hover:border-pink-100 border-transparent"
                    >
            ...
            <div className="w-1/3 relative bg-gradient-to-br from-pink-500/20 to-purple-600/20 overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-6">
                ...
                <p className="text-gray-200 text-xs">
                  Transform your hiring and verification processes
                </p>
              </div>
            </div>
          </div>
