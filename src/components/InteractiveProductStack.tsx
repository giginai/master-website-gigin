  ...
  const products = [
    {
      ...
      name: "Gigin Jobs",
      color: "bg-pink-500",
      image: "/lovable-uploads/0ad9fa2c-813d-47a5-b34b-0f5101739266.png",
    ...
    },
    {
      ...
      name: "Gigin VerifyIn",
      color: "bg-pink-500",
      image: "/lovable-uploads/10edcaaa-ccb6-4b12-bef5-c307377797bf.png",
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8 py-[32px]">
                  ...
                  <div className="bg-black/60 backdrop-blur-sm rounded-lg p-6 mb-2">
