        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3">
            <div className="grid grid-cols-2 lg:grid-cols-1 gap-3">
              {products.map(product => <button key={product.id} onClick={() => setActiveProduct(product.id)} className={`relative p-4 rounded-lg transition-all duration-300 text-left ${activeProduct === product.id ? `${product.color} text-white shadow-lg transform scale-105` : "bg-white text-gray-700 border border-gray-200 hover:border-gray-300 hover:shadow-md"}`}>
