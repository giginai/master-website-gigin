        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="relative max-w-6xl mx-auto">
            <div className="relative overflow-hidden rounded-t-3xl group h-64 md:h-80 lg:h-96">
              <img src="/lovable-uploads/56a40185-261b-4872-a09a-a76c5af61583.png" alt="Gigin AI-Driven Hiring Platform" className="w-full h-full object-cover object-top transition-transform duration-700 ease-out group-hover:scale-105" style={{
      ...
      <section className="relative z-10 py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <Accordion type="single" collapsible className="w-full max-w-6xl mx-auto">
            {accordionItems.map((item, index) => <AccordionItem key={item.id} value={item.id} className="border border-gray-200 rounded-2xl mb-6 bg-white shadow-lg hover:shadow-xl transition-all duration-300">
                <AccordionTrigger className="hover:no-underline group py-8 px-8 [&>svg]:hidden">
                  <div className="flex items-center justify-between w-full">
                    <div className="flex items-center space-x-6">
                      <div className="w-12 h-12 bg-gradient-to-br from-gray-900 via-black to-gray-800 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg">
                        {index + 1}
                      </div>
                    ...
                    <div className="w-8 h-8 flex items-center justify-center">
                      <svg className="h-5 w-5 text-gray-500 group-hover:text-pink-600 transition-all duration-300 group-data-[state=open]:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <AccordionContent className="px-8 pb-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mt-4">
                    ...
                    <div className="relative">
                      <img src={`https://images.unsplash.com/${item.image}?auto=format&fit=crop&w=800&q=80`} alt={item.title} className="w-full h-64 object-cover rounded-2xl shadow-lg" />
                    </div>
                  </div>
                </AccordionContent>
              </AccordionItem>)}
      ...
      <section className="relative z-10 py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {cardFeatures.map((feature, index) => <Card key={index} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 group">
                <div className="relative">
                  <img src={`https://images.unsplash.com/${feature.image}?auto=format&fit=crop&w=600&q=80`} alt={feature.title} className="w-full h-48 object-cover rounded-t-2xl" />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="relative max-w-6xl mx-auto mt-12">
            <div className="h-64 md:h-80 lg:h-96 overflow-hidden">
              <img src="/lovable-uploads/56a40185-261b-4872-a09a-a76c5af61583.png" alt="Gigin Platform Dashboard" className="w-full h-full object-cover object-top" style={{
              objectPosition: 'center top'
            }} />
            </div>
          </div>
