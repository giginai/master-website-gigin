...
const VerificationCatalogue = () => {
  const verificationCategories = [
    {
      ...
      checks: [
        { name: "Passport Verification", link: "/verification/identity" },
        { name: "PAN ID Verification", link: "/verification/identity" },
        { name: "Aadhaar Verification", link: "/verification/identity" },
        { name: "Voter ID Verification", link: "/verification/identity" },
        { name: "TIN Verification", link: "/verification/identity" },
        { name: "GSTIN Verification", link: "/verification/identity" }
      ]
    },
    {
      ...
      checks: [
        { name: "Employment History Check", link: "/verification/employment" },
        { name: "Salary Verification", link: "/verification/employment" },
        { name: "Job Title Verification", link: "/verification/employment" },
        { name: "Reference Check", link: "/verification/reference" }
      ]
    },
    {
      ...
      checks: [
        { name: "Degree Verification", link: "/verification/education" },
        { name: "Professional Certification", link: "/verification/education" },
        { name: "Training Certificate Validation", link: "/verification/education" }
      ]
    },
    {
      ...
      checks: [
        { name: "Criminal Background Check", link: "/verification/criminal" },
        { name: "Court Records Search", link: "/verification/criminal" },
        { name: "Global Watchlist Check", link: "/verification/criminal" }
      ]
    },
    {
      ...
      checks: [
        { name: "Current Address Verification", link: "/verification/address" },
        { name: "Permanent Address Check", link: "/verification/address" },
        { name: "Residence History Validation", link: "/verification/address" }
      ]
    },
    {
      ...
      checks: [
        { name: "Credit Score Check", link: "/verification/financial" },
        { name: "Bankruptcy Records", link: "/verification/financial" },
        { name: "Financial Stability Assessment", link: "/verification/financial" }
      ]
    },
    {
      ...
      checks: [
        { name: "Professional Social Media Check", link: "/verification/social" },
        { name: "Public Records Analysis", link: "/verification/social" },
        { name: "Digital Footprint Assessment", link: "/verification/social" }
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="space-y-12">
                {verificationCategories.map((category, categoryIndex) => (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {category.checks.map((check, checkIndex) => (
                        <Link 
                          key={checkIndex}
                          to={check.link}
                          className="bg-white p-6 rounded-xl border border-gray-200 hover:border-pink-300 hover:bg-pink-50 transition-all duration-300 group"
                        >
