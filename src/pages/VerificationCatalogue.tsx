  ...
  const verificationCategories = [
    {
      ...
      icon: Shield,
      description:
        "AI-powered ID authentication for government-issued documents. Biometric matching for fraud-proof identity validation. Automated risk assessment for fake profiles and identity theft.",
      checks: [
        {
    ...
    },
    {
      ...
      icon: Building,
      description:
        "Comprehensive employment history validation with multi-source database verification and automated cross-checking of job roles, tenure, and salary analysis.",
      checks: [
        {
    ...
    },
    {
      ...
      icon: CheckCircle,
      description:
        "Ensure confidence in candidate qualifications with fast verification processes, AI-assisted certificate authentication and degree validation.",
      checks: [
        {
    ...
    },
    {
      ...
      icon: FileCheck,
      description:
        "Reliable international criminal record screening by AI scanning for court cases, legal disputes, and criminal sanctions for high-security roles.",
      checks: [
        {
    ...
    },
    {
      ...
      icon: Eye,
      description:
        "Real-time address validation and residence history verification using multiple databases and AI-powered cross-referencing for accuracy.",
      checks: [
        {
    ...
    },
    {
      ...
      icon: CreditCard,
      description:
        "Comprehensive financial history checks including credit scores, bankruptcy records, and financial stability assessment for high-trust positions.",
      checks: [
        {
    ...
    },
    {
      ...
      icon: Globe,
      description:
        "AI-powered social media analysis for professional reputation assessment, identifying potential risks and ensuring brand alignment.",
      checks: [
        {
      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-gray-900 via-black to-gray-800">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            Comprehensive verification solutions tailored to your specific
            needs. Choose from our extensive catalogue of AI-powered
                      ...
                      {category.checks.map((check, checkIndex) => (
                        ...
                        >
                          ...
                          <p className="text-gray-600 text-sm">
                            Comprehensive verification with AI-powered analysis
