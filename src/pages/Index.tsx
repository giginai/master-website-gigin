...
const Index = () => {
  return (
    <>
      <Helmet>
        <title>
          Smart Hiring & Background Verification for India's Growing Workforce |
          Gigin
        </title>
        <meta
          name="description"
          content="Gigin helps businesses simplify background verification and access a verified workforce across India. Hire faster with trust and compliance built-in."
        />
        <link
          rel="canonical"
          href="https://master-website-gigin.lovable.app/home"
        />
        <meta
          property="og:title"
          content="Smart Hiring & Background Verification for India's Growing Workforce | Gigin"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://master-website-gigin.lovable.app/home"
        />
        <meta
          property="og:image"
      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url(/lovable-uploads/b4b1c883-f32c-4d6f-8b13-b57cf11be4e2.png)",
          }}
        >
